...
public class Items {
    ...
    public static final RegistryObject<Item> MUSIC_DISC_FARLANDS = REGISTRY.register("music_disc_farlands",() -> new RecordItem(15, Sounds.MUSIC_FARLANDS.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 2400));
    public static final RegistryObject<Item> MUSIC_DISC_NEVER_ALONE = REGISTRY.register("music_disc_never_alone", () -> new RecordItem(15, Sounds.MUSIC_NEVER_ALONE.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON), 2600));
