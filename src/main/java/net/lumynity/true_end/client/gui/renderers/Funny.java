...
public class Funny extends AbstractContainerScreen<net.lumynity.true_end.client.gui.inventory.Funny> {

    public Funny(net.lumynity.true_end.client.gui.inventory.Funny container, Inventory inventory, Component text) {
